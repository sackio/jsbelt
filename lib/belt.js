  ...
  var Belt = function(){
    ...
    */
    B['stringify'] = function(obj){
      if (B.typeof(obj).match(/^(string|number|boolean|function|null|regexp|undefined|date)$/)) return B.cast(obj, 'string');
    ...
    */
    B['cast'] = function(a, type){
      ...
      if (type === 'object'){
        ...
        return a ? B.deepObj([B.cast(a, 'string')], [a]) : undefined;
      }

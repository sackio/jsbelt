  ...
  var Belt = function(){
    ...
    */
    B['deepEqual'] = function(obj, obj2){
      ...
      if (typeof obj === 'undefined' && typeof obj2 === 'undefined') return true;
      if (obj === null && obj2 === null) return true;

      if (typeof obj !== 'object' && (!B._get(obj, 'toString') || !B._get(obj2, 'toString'))) return false;

      var str1 = typeof obj === 'object' ? JSON.stringify(obj) : B._call(obj, 'toString')
        , str2 = typeof obj2 === 'object' ? JSON.stringify(obj2) : B._call(obj, 'toString');
